...
public class DesertCupActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desertcup);
        ...
        imgId[0] = (R.drawable.desert_1);
        imgId[1] = (R.drawable.desert_2);
        imgId[2] = (R.drawable.desert_3);
        imgId[3] = (R.drawable.desert_4);
        imgId[4] = (R.drawable.desert_5);
        imgId[5] = (R.drawable.desert_6);
        imgId[6] = (R.drawable.desert_7);
        imgId[7] = (R.drawable.desert_8);
        for (i = 0; i < 8; i++) {
