...
public class ChickenCupActivity extends AppCompatActivity {
    TextView vsText;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meatcup);
        ...
        imgId[0] = (R.drawable.chicken_1);
        imgId[1] = (R.drawable.chicken_2);
        imgId[2] = (R.drawable.chicken_3);
        imgId[3] = (R.drawable.chicken_4);
