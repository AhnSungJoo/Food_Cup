...
public class AsianCupActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.asiancup);
        ...
        imgId[0] = (R.drawable.asian_1);
        imgId[1] = (R.drawable.asian_2);
        imgId[2] = (R.drawable.asian_3);
        imgId[3] = (R.drawable.asian_4);
        imgId[4] = (R.drawable.asian_5);
        imgId[5] = (R.drawable.asian_6);
        imgId[6] = (R.drawable.asian_7);
        imgId[7] = (R.drawable.asian_8);
