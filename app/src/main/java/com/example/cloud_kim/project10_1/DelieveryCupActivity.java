...
public class DelieveryCupActivity extends AppCompatActivity {
    TextView vsText;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.delieverycup);
        ...
        imgId[0] = (R.drawable.delivery_1);
        imgId[1] = (R.drawable.delivery_2);
        imgId[2] = (R.drawable.delivery_3);
        imgId[3] = (R.drawable.delivery_4);
        imgId[4] = (R.drawable.delivery_5);
        imgId[5] = (R.drawable.delivery_6);
        imgId[6] = (R.drawable.delivery_7);
        imgId[7] = (R.drawable.delivery_8);
        for (i = 0; i < 8; i++) {
